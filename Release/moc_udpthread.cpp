...
QT_MOC_LITERAL(1, 10, 10), // "getMessage"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 3), // "msg"
QT_MOC_LITERAL(4, 26, 15) // "on_dataReceived"

    },
    "UDPThread\0getMessage\0\0msg\0on_dataReceived"
};
...
void UDPThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getMessage((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UDPThread::getMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UDPThread::getMessage(QByteArray _t1)
{
